					...
					for (i = 0; i < nFreqsSam; i++) {
						...
						for(nant1 = 0; nant1 < nAnts; nant1++) {
							...
							for(nant2 = nant1; nant2 < nAnts; nant2++) {
								...
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2)   ] += (float)(in1rx*in2rx + in1ix*in2ix) / 2. / nFreqsSam / nTimeSam; // real XX
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +1] += (float)(in1rx*in2ix - in1ix*in2rx) / 2. / nFreqsSam / nTimeSam; // imag XX
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +2] += (float)(in1rx*in2ry + in1ix*in2iy) / 2. / nFreqsSam / nTimeSam; // real XY
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +3] += (float)(in1rx*in2iy - in1ix*in2ry) / 2. / nFreqsSam / nTimeSam; // imag XY
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +4] += (float)(in1ry*in2rx + in1iy*in2ix) / 2. / nFreqsSam / nTimeSam; // real YX
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +5] += (float)(in1ry*in2ix - in1iy*in2rx) / 2. / nFreqsSam / nTimeSam; // imag YX
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +6] += (float)(in1ry*in2ry + in1iy*in2iy) / 2. / nFreqsSam / nTimeSam; // real YY
								corrs[ (nBLines-(nAnts-nant1-1)*(nAnts-nant1)/2+nant2-25)*(nSubChans*nPols*2*2) + nc*(nPols*2*2) +7] += (float)(in1ry*in2iy - in1iy*in2ry) / 2. / nFreqsSam / nTimeSam; // imag YY
							}
						}
					}
				}
